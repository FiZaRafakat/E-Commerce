     ...
     <div className="flex justify-between items-end">
        ...
        <div className="images flex flex-col sm:flex-row gap-8 text-white">
            ...
            <div className="img bg-black sm:h-[615px] h-[400px]  w-full relative rounded-lg ">
             <Image src="/playStation.png" alt="" className='mx-auto absolute bottom-0 xl:w-auto min-[450px]:w-[400px] right-0  lg:left-12'/>
           ...
           <div className="img bg-[#0D0D0D] lg:h-[285px] h-[200px] w-full rounded-lg relative ">
             <Image src="/women.png" alt="" className='absolute rounded-l-lg h-[200px]  xl:h-auto bottom-0 lg:left-32 right-0'/>
             <div className='absolute lg:left-8 lg:bottom-8 bottom-6 left-6 '>
            ...
            <div className='flex flex-col lg:flex-row gap-8 xl:mt-3'>
             ...
             <Image src="/speaker.png" alt="" className='absolute h-[150px] lg:h-auto rounded-l-lg lg:bottom-8 bottom-0 right-0 lg:left-10'/>
             <div className='absolute lg:left-8 lg:bottom-8 bottom-6 left-6 '>
              ...
              <div className="img bg-[#0D0D0D]/90 lg:h-[300px] h-[185px] w-full rounded-lg relative ">
             <Image src="/perfume.png" alt="" className='absolute  h-[150px] lg:h-auto rounded-l-lg lg:bottom-8 bottom-0 right-0 lg:left-10'/>
             <div className='absolute lg:left-8 lg:bottom-8 bottom-6 left-6 '>
